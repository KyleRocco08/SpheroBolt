 ...
 * LED turn to Blue
 * Forward for 2 seconds at 60 speed
*/
...
async function startProgram() {
    await helloWorld()    //<--calling the startProgram function to run it
    await ninetyDegree()    //<--calling the ninetyDegeree function to run it
